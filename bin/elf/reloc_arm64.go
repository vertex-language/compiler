...
//
// Symbol definitions follow the same A/B/G/GOT/L/P/S/Z convention as AMD64.
// Additional AArch64-specific symbols:
...
const (
	...
	R_AARCH64_ABS32 = 258 // S + A                (32-bit absolute, assert fits)
	R_AARCH64_ABS16 = 259 // S + A                (16-bit absolute, assert fits)
	...
	// ── Thread-local storage relocations (General Dynamic / Local Dynamic) ─
	...
	// ── Thread-local storage relocations (Initial Exec / Local Exec) ─────
