...
func (fc *funcCompiler) skipDeadOp(r *decode.Reader, op byte) error {
	...
	case 0x3F, 0x40:
		if _, err := r.ReadByte(); err != nil { return err }
	case 0x41:
		if _, err := r.ReadS32(); err != nil { return err }
	case 0x42:
		if _, err := r.ReadSLEB128(); err != nil { return err }
	case 0x43:
		if _, err := r.ReadFixedBytes(4); err != nil { return err }
	case 0x44:
		if _, err := r.ReadFixedBytes(8); err != nil { return err }
	case 0xD0:
		if _, err := r.ReadByte(); err != nil { return err }
	case 0xD2:
		if _, err := r.ReadU32(); err != nil { return err }
...
func skipFCImm(r *decode.Reader, subOp uint32) error {
	...
	case 8:
		if _, err := r.ReadU32(); err != nil { return err }
		_, err := r.ReadByte(); return err
	case 9, 13:
		_, err := r.ReadU32(); return err
	case 10:
		if _, err := r.ReadByte(); err != nil { return err }
		_, err := r.ReadByte(); return err
	case 11:
